def divide(quotients, divisors):
    ...
    """
    return {values: [i for i in divisors if i % values==0] for values in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    middle_city=make_city('middle_city',lat,lon)
    if distance(city_a,middle_city) < distance(city_b,middle_city):
